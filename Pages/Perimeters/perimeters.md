...
### **- Уменьшение лага**
 Избавляясь от лишних блоков в радиусе прорузки, мы не загружаем их в память и не обрабатываем каждый тик. А именно - сундуки, трава, растущий тростник, спавн и ИИ нейтральных мобов и ТД.
### **- Декорации**
...
Используйте схему World Eater выровнянную по территории и расчистите колонну блоков до бедрока под разметкой из белой шерсти
